...
export default function GiftedStudentsSection() {
  const { t } = useTranslation();

  return (
    <>
      <HeaderImg
        text="gifted_students_section"
        paths={[
          {
      ...
      <div className="responsive">
        <div className=" flex justify-between items-end w-full border-b mt-10">
          <h2 className="md:text-2xl text-base mb-0 text-black">{t("gifted_students_section")}</h2>
        </div>
      </div>
      <div className="responsive">
